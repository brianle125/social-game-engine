...
std::string toStringVisitor::operator()(vector<dataBucket> v) const {
    std::string s = "[";
    int n = v.size();
    int i;
    for(i = 0; i < n - 1; i++) {
...
std::string toStringVisitor::operator()(map<std::string, dataBucket> m) const {
    std::string s = "(";
    auto i = m.begin();
    auto i2 = m.begin();
    i2++;
...
void shuffleVisitor::operator()(vector<dataBucket> v) {
...
// void addVisitor::operator()(vector<dataBucket> v) {
